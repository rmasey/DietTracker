...
public class ConsumptionService {
    ...
    public static List<Consumption> selectAll(int userID) {
        ...
        PreparedStatement statement = StageOne.database.newStatement("SELECT userID, mealName, foodName, calories, dateEaten FROM Consumption where userID = " + userID);
    ...
    public static void save(Consumption itemToSave) {
        ...
        try{
            statement = StageOne.database.newStatement("INSERT INTO Consumption (userID, mealName, foodName, calories) VALUES (?, ?, ?, ?)");
